...
class P04CALENDARINSTRUMENTGETDATA_Bloc
  ...
  Future<void> _P04CALENDARINSTRUMENTGETDATA_GET(List<P04CALENDARINSTRUMENTGETDATAclass> toAdd,
    ...
    try {
      ...
      Navigator.pop(P04CALENDARINSTRUMENTMAINcontext);
      if (e.type == DioExceptionType.sendTimeout) {
        showErrorPopup(P04CALENDARINSTRUMENTMAINcontext, "Send timeout");
      } else if (e.type == DioExceptionType.receiveTimeout) {
        showErrorPopup(P04CALENDARINSTRUMENTMAINcontext, "Receive timeout");
      } else {
        showErrorPopup(P04CALENDARINSTRUMENTMAINcontext, e.message ?? "Unknown Dio error");
      }
    } catch (e) {
      Navigator.pop(P04CALENDARINSTRUMENTMAINcontext);
      showErrorPopup(P04CALENDARINSTRUMENTMAINcontext, e.toString());
    }
  }
