...
abstract class P07ASSEMBLEGRAPHGETDATA1_Event {}

class P07ASSEMBLEGRAPHGETDATA1_GET extends P07ASSEMBLEGRAPHGETDATA1_Event {}

class P07ASSEMBLEGRAPHGETDATA1_GET2 extends P07ASSEMBLEGRAPHGETDATA1_Event {}

class P07ASSEMBLEGRAPHGETDATA1_GET3 extends P07ASSEMBLEGRAPHGETDATA1_Event {}

class P07ASSEMBLEGRAPHGETDATA1_FLUSH extends P07ASSEMBLEGRAPHGETDATA1_Event {}

class P07ASSEMBLEGRAPHGETDATA1_Bloc
    extends Bloc<P07ASSEMBLEGRAPHGETDATA1_Event, List<P07ASSEMBLEGRAPHGETDATA1class>> {
  P07ASSEMBLEGRAPHGETDATA1_Bloc() : super([]) {
    on<P07ASSEMBLEGRAPHGETDATA1_GET>((event, emit) {
      return _P07ASSEMBLEGRAPHGETDATA1_GET([], emit);
    });

    on<P07ASSEMBLEGRAPHGETDATA1_GET2>((event, emit) {
      return _P07ASSEMBLEGRAPHGETDATA1_GET2([], emit);
    });
    on<P07ASSEMBLEGRAPHGETDATA1_GET3>((event, emit) {
      return _P07ASSEMBLEGRAPHGETDATA1_GET3([], emit);
    });
    on<P07ASSEMBLEGRAPHGETDATA1_FLUSH>((event, emit) {
      return _P07ASSEMBLEGRAPHGETDATA1_FLUSH([], emit);
    });
  }

  Future<void> _P07ASSEMBLEGRAPHGETDATA1_GET(
      List<P07ASSEMBLEGRAPHGETDATA1class> toAdd, Emitter<List<P07ASSEMBLEGRAPHGETDATA1class>> emit) async {
    FreeLoadingTan(P07ASSEMBLEGRAPHMAINcontext);
    List<P07ASSEMBLEGRAPHGETDATA1class> output = [];
    //-------------------------------------------------------------------------------------
    final response = await Dio().post(
      ...
      data: {
        ...
        // 'YEAR': P07ASSEMBLEGRAPHVAR.DropDownYear.toString(),
      },
    );
    var input = [];
    if (response.statusCode == 200) {
      ...
      List<P07ASSEMBLEGRAPHGETDATA1class> outputdata = input.map((data) {
        return P07ASSEMBLEGRAPHGETDATA1class(
  ...
  Future<void> _P07ASSEMBLEGRAPHGETDATA1_GET2(
      List<P07ASSEMBLEGRAPHGETDATA1class> toAdd, Emitter<List<P07ASSEMBLEGRAPHGETDATA1class>> emit) async {
    // List<P07ASSEMBLEGRAPHGETDATA1class> output = [];
    //-------------------------------------------------------------------------------------
    // var input = dummydatainput2;

    // List<P07ASSEMBLEGRAPHGETDATA1class> outputdata = input
    //     .where((data) =>
    //         data['location'] == 'ESIE1' &&
    //         data['plant'] == 'YES' &&
    //         data['step01'] == 'YES')
  ...
  Future<void> _P07ASSEMBLEGRAPHGETDATA1_GET3(
      List<P07ASSEMBLEGRAPHGETDATA1class> toAdd, Emitter<List<P07ASSEMBLEGRAPHGETDATA1class>> emit) async {
    // List<P07ASSEMBLEGRAPHGETDATA1class> output = [];
    //-------------------------------------------------------------------------------------
    // List<P07ASSEMBLEGRAPHGETDATA1class> datadummy = [
    //   P07ASSEMBLEGRAPHGETDATA1class(
    //     PLANT: "PH PO:1234",
    //     STEP01: "YES",
    //     STEP02: "YES",
    //     STEP03: "YES",
  ...
  Future<void> _P07ASSEMBLEGRAPHGETDATA1_FLUSH(
      List<P07ASSEMBLEGRAPHGETDATA1class> toAdd, Emitter<List<P07ASSEMBLEGRAPHGETDATA1class>> emit) async {
    List<P07ASSEMBLEGRAPHGETDATA1class> output = [];
    emit(output);
  }
...
class P07ASSEMBLEGRAPHGETDATA1class {
  P07ASSEMBLEGRAPHGETDATA1class({
    this.TYPE = '',
    this.MKTGROUP = '',
    this.GROUP = '',
